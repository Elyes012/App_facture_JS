 function addRow() {
     ...
     var m=0;
      ...
      td4.innerHTML = z;
      td5.innerHTML = document.getElementById("TVA").value;;
      td6.innerHTML = t;
...
function prixht() {
 ...
 document.getElementById("prixhtva").innerHTML = "Total H.T.V.A =" + somme
}
...
function prixtva() {
 ...
 document.getElementById("prixhtva1").innerHTML = "Total T.T.C =" + tt
}
